...
clientChallenger.on('message', async (msg) => {
    // DEBUG: Log all group messages containing battle links
    if (msg.isGroup && msg.body.includes('https://quizmd.online/battle/')) {
        console.log(`[DEBUG GROUP MSG] ${msg.body.substring(0, 120)}...`);
    }
